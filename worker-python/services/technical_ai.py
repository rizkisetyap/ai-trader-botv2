...
import cloudscraper  # <-- Senjata rahasia penembus Cloudflare
from sklearn.ensemble import RandomForestClassifier
from sklearn.model_selection import train_test_split

# --- TOPENG ANTI-CLOUDFLARE (MENIRU SIDIK JARI CHROME) ---
...
def analisa_teknikal(ticker_code):
    try:
        # Gunakan session dari cloudscraper
        saham = yf.Ticker(ticker_code, session=scraper)
    ...
    # --- SABUK PENGAMAN AGAR BOT TELEGRAM TIDAK CRASH ---
    except Exception as e:
        print(f"[-] Gagal mengambil data {ticker_code} dari Yahoo Finance: {e}")
        # Mengembalikan None agar main.py tahu data gagal diambil
